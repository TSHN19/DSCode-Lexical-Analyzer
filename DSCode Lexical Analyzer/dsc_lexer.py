from tokentypes import TT_Operators, TT_ControlFlowKeywords, TT_DataTypeKeywords, TT_StorageClassKeywords, TT_OtherKeywords, TT_Delim
...
def lexical_analyzer(code):
    ...
    delims = [symbol for symbol, _ in TT_Delim]   
    ...
    for i in range(len(code)):
        ...
        # Check if input is a operator or special symbol
            ...
            if code[i + 1] in symbols:
                ...
                token_description = TT_Delim[index][1]
